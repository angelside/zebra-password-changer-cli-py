...
> Zebra Password Changer CLI is a _"blazingly fast 🤣"_ Python CLI tool that allows changing the Zebra printer's web interface password with socket protocol.
